...
const getModelos = async () => {
  const headers = getHeaderToken();
  const response = await axios
    .get(process.env.REACT_APP_HOST + "Operaciones/ActualPre/modelos", headers)
    .catch((error) => errorsHandling(error));
  return response.data;
};
...
const getOficialesMora = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/oficialesmora",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const getOficialesPC = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/oficialespc",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const getOficialesScoring = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/oficialesScoring",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const getOrigenSuscripcion = async () => {
  const headers = getHeaderToken();
  const response = await axios
    .get(process.env.REACT_APP_HOST + "Operaciones/ActualPre/origen", headers)
    .catch((error) => errorsHandling(error));
  return response.data;
};
...
const getPuntosVenta = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/puntosventa",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const getFormasPago = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/formasPago",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const getTarjetas = async () => {
  const headers = getHeaderToken();
  const response = await axios
    .get(process.env.REACT_APP_HOST + "Operaciones/ActualPre/tarjetas", headers)
    .catch((error) => errorsHandling(error));
  return response.data;
};
...
const getIntereses = async () => {
  ...
  const response = await axios
    .get(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/intereses",
      headers
    )
    .catch((error) => errorsHandling(error));
  return response.data;
...
const pagoSenia = async (data) => {
  ...
  const response = await axios
    .post(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/pagoSenia",
      data,
      headers
    )
    .catch((error) => errorsHandling(error));
...
const deletePago = async (data) => {
  ...
  const response = await axios
    .post(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/deletePago",
      data,
      headers
    )
    .catch((error) => errorsHandling(error));
...
const updatePago = async (data) => {
  ...
  const response = await axios
    .post(
      process.env.REACT_APP_HOST + "Operaciones/ActualPre/updatePago",
      data,
      headers
    )
    .catch((error) => errorsHandling(error));

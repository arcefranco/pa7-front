...
const Sucursales = () => {
  ...
  useEffect(() => {
    ...
    if (
      sucursalStatus &&
      Object.keys(sucursalStatus).length &&
  ...
  useEffect(() => {
    if (sucursalStatus && Object.keys(sucursalStatus).includes("codigo")) {
      setInEdit(sucursalStatus?.codigo ? sucursalStatus.codigo : "");
    }
  ...
  const handleChange = (e) => {
    ...
    const newForm = { ...newSucursal, [name]: value };
  ...
  const currentRecords = sucursales.slice(
    indexOfFirstRecord,
    indexOfLastRecord
  );
  ...
  return (
    <div className={styles.container}>
      ...
      sucursalStatus &&
      Object.keys(sucursalStatus).length &&
      !sucursalStatus.codigo &&
      typeof sucursalStatus.codigo !== "number" ? (
        <ModalStatus
          status={sucursalStatus?.status}
          message={sucursalStatus?.message}
        />
      ) : null}
      ...
      <div className={styles.buttonAddContainer}>
        <ReactTooltip id="botonTooltip2">Agregar nueva sucursal</ReactTooltip>

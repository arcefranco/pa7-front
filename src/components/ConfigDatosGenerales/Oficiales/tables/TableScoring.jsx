...
useEffect(() => {
  ...
  function endEdit () {
      dispatch(endUpdate({Codigo: actualInEdit.current, categoria: 'Scoring'}))
  }
    ...
    <table>
...

                {
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="text" name="Objetivo" value={newOficial.Objetivo} onChange={handleChange}/>
                        </td>
                        <td></td>
                ...
                {
                    currentRecords && currentRecords.map(e => <OficialItem 
                      key={e.Codigo} 
                      Categoria={'Scoring'} 
                      Codigo={e.Codigo} 
                      Nombre={e.Nombre} 

...
import { getTeamLeaders, postTeamLeaders, resetStatus, endUpdate, getAllSupervisores } from "../../../reducers/ConfigDatosGenerales/TeamLeaders/teamLeadersSlice";
...
const TeamLeaders = () => {
    ...
    useEffect(() => {
     ...
     useEffect(() => { //Manejar actualizaciones de vendedores (ABM) y su inUpdate
        ...
        function resetModal () {
         ...
         if(Object.keys(statusNuevoTeamLeader).length){ 
     ...
     useEffect(() => {
        if(Object.keys(statusNuevoTeamLeader).includes('codigo')) {
    ...
    const currentRecords = teamLeaders.slice(indexOfFirstRecord, 
        indexOfLastRecord);
    ...
    return (
        ...
        <div className={styles.container}>
            {
                modal && Object.keys(statusNuevoTeamLeader).length && Object.keys(statusNuevoTeamLeader).includes('status') ? 
                <ModalStatus status={statusNuevoTeamLeader?.status} message={statusNuevoTeamLeader?.message}/> :
                null
            } 
        ...
        <TableContainer>
            <table>
...

                {
                    ...
                    <tr>
                        <td></td>
                        <td><input type="text" name="Nombre" value={newTeamLeader.Nombre} onChange={handleChange}/></td>
                        <td>
                        ...
                        <td><input type="checkbox" name="Activo" value={newTeamLeader.Activo}  onChange={handleCheckChange}/></td>

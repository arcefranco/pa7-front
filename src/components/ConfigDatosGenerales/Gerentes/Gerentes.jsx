...
import { getGerentes, postGerentes, endUpdate, resetStatus } from '../../../reducers/ConfigDatosGenerales/Gerentes/gerentesSlice'
        ...
        <ReactTooltip id="botonTooltip2">
            ...
            <TableContainer>
                ...
                
                {
                    ...
                    <GerentesItem key={e.Codigo} Codigo={e.Codigo} Nombre={e.Nombre} Activo={e.Activo}/>)
                }

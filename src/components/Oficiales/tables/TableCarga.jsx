  ...
  const defaultColumns = useMemo(() => [
          ...
          
        {
...

              {
                ...
                <button style={{background:'#3dc254bf'}} className={styles.buttonRows}  onClick={(()=> navigate(`/modifOficiales/Carga/${value.value}`))}>Modificar</button> :
                  ...
                  <button style={{background:"red"}} onClick={(()=> {
                    Swal.fire({
                      ...
                      if(result.isConfirmed){
                        ...
                        dispatch(deleteOficiales({oficialName: 'Carga', Codigo: value.value}))
                      }
                    })

    ...
    const defaultColumns = useMemo(() => [
        {
          ...
          
          {
            ...
            },
            {
                ...
                <button style={{background:'#3dc254bf'}} className={styles.buttonRows}  onClick={(()=> navigate(`/modifOficiales/Subite/${value.value}`))} >Modificar</button> :
                  ...
                  <button style={{background:"red"}} onClick={(()=> {
                    Swal.fire({
                      ...
                      if(result.isConfirmed){
                         dispatch(deleteOficiales({oficialName: 'Subite', Codigo: value.value})) 
                      }
                    })

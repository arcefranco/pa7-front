  ...
  const defaultColumns = useMemo(() => [
          ...
          
        {
...

              {
                ...
                <button style={{background:"burlywood"}} className={styles.buttonRows}  onClick={(()=> navigate(`/modifOficiales/Canje/${value.value}`))}>Modificar</button> :
                  ...
                  <button style={{background:"red"}} onClick={(()=> {
                    Swal.fire({
                      ...
                      if(result.isConfirmed){
                        ...
                        dispatch(deleteOficiales({oficialName: 'Plan Canje', Codigo: value.value}))
                      }
                    })

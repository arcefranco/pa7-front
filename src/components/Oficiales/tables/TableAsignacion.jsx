  ...
  const defaultColumns = useMemo(() => [
          ...
          
        {
...

              {
                ...
                <button style={{background:"burlywood"}} className={styles.buttonRows}  onClick={(()=> navigate(`/modifOficiales/Asignacion/${value.value}`))} >Modificar</button> :
                  ...
                  <button style={{background:"red"}} onClick={(()=> {
                    Swal.fire({
                      ...
                      if(result.isConfirmed){
                        ...
                        dispatch(deleteOficiales({oficialName: 'Asignacion', Codigo: value.value}))
                      }
                    })

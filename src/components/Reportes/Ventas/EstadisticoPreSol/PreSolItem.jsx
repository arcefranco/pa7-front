        ...
        <TableContainer>
            <table>
                ...
                <tr style={{backgroundColor: 'white'}}>
                    ...
                    <td  className={styles.tdNumber} onClick={() => navigate(`/reportes/preSol/ProdYCS/${fechaD.split('-').join("")}/${fechaH.split('-').join("")}/${pMarca}/${JSON.stringify([array[0].CodSucursal])}`)}>
